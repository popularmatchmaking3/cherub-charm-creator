    ...
    Views: {
      app_settings_public: {
        Row: {
          ...
          daily_message_limit_free: number | null
          daily_message_limit_premium: number | null
          id: number | null
          maintenance_message: string | null
          maintenance_mode: boolean | null
          membership_enabled: boolean | null
          payments_enabled: boolean | null
          review_approved_welcome: string | null
          review_pending_message: string | null
          review_rejected_message: string | null
      ...
      profiles_public: {
        Row: {
          about: string | null
          accept_audio_calls: boolean | null
          accept_video_calls: boolean | null
          annual_income: string | null
          avatar_url: string | null
          city: string | null
          country: string | null
          ...
          disability_category:
            ...
            | null
          disability_percentage: number | null
          disability_verification_status: string | null
